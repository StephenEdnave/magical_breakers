...
enum STATE_IDS { IDLE, ROAM, RETURN, SPOT, FOLLOW, STAGGER, CHARGE_PREPARE, CHARGE, CHARGE_COOLDOWN, BUMP, DIE, DEAD}
onready var STATES = {
	IDLE:$'States/Idle',
	ROAM:$'States/Roam',
...
func take_damage(source, amount, effect, damage_type, knockback_force):
	...
	STATES[STAGGER].setup(knockback_direction, knockback_force)
